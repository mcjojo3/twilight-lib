...
public class WolfPrintParticle extends TextureSheetParticle {
    ...
    protected WolfPrintParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz,
            SpriteSet spriteSet) {
        super(world, x, y, z);
    ...
    public void render(VertexConsumer buffer, Camera camera, float partialTicks) {
        // Custom rendering to make footprint lay flat on ground (in XZ plane, not
        // billboard)
        ...
        // The quad is horizontal (parallel to ground), rotated around Y axis to face
        // movement direction
        ...
        // In 1.21.1, VertexConsumer API changed - vertex() now requires position as
        // separate method
