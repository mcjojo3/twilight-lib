...
public class AddonInit {
        ...
        public static void registerAddons() {
                ...
                LOGGER.info("I like all these things around me! {} addons registered.",
        ...
        private static void registerKitsuneVariants() {
                ...
                LOGGER.info("There are so many weirdos here... It's awesome! Registered {} kitsune variants (ears + snout + tails + tail variants + alt variants).",
                                totalAddons);
        }
}