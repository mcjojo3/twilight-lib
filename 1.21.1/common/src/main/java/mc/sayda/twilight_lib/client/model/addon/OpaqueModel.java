 ...
 * Uses the player's skin texture and forces all addons to render with transparency.
 */
public class OpaqueModel<T extends Entity> extends BaseAddonModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(TwilightLib.MODID, "opaque_model"), "main");
