...
public class HarpyLegsAltModel<T extends Entity> extends BaseAddonModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(TwilightLib.MODID, "harpy_legs_alt"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
                CubeListBuilder.create().texOffs(41, 0)
                        .addBox(-2.1F, 11.0F, -1.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
                CubeListBuilder.create().texOffs(41, 13)
                        .addBox(-0.9F, 11.0F, -1.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
                        ...
                        .texOffs(48, 20).addBox(1.1F, 11.0F, -3.5F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
                PartPose.offset(1.9F, 8.0F, 0.0F));

        LeftLeg.addOrReplaceChild("LeftLeg_r1", CubeListBuilder.create().texOffs(17, 14).addBox(-1.0F, -0.4F, -4.85F,
