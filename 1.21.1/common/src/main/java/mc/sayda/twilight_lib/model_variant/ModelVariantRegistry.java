...
public class ModelVariantRegistry implements IModelVariantRegistry {
    ...
    public ModelVariantRegistry() {
        register(new DefaultModelVariant(ResourceLocation.fromNamespaceAndPath("twilight_lib", "steve"), "default"));
        register(new DefaultModelVariant(ResourceLocation.fromNamespaceAndPath("twilight_lib", "alex"), "slim"));
    }
