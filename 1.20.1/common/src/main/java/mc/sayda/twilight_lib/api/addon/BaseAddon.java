...
public abstract class BaseAddon implements IAddon {
    ...
    protected BaseAddon(ResourceLocation id, AddonType type, ModelLayerLocation layerLocation,
        ...
        this(id, type, layerLocation, layerDefinition, texture, Set.of(), Set.of(), false);
    }

    protected BaseAddon(ResourceLocation id, AddonType type, ModelLayerLocation layerLocation,
            Supplier<LayerDefinition> layerDefinition, ResourceLocation texture,
            Set<String> requiredModIds) {
        this(id, type, layerLocation, layerDefinition, texture, requiredModIds, Set.of(), false);
    }

    protected BaseAddon(ResourceLocation id, AddonType type, ModelLayerLocation layerLocation,
            Supplier<LayerDefinition> layerDefinition, ResourceLocation texture,
            Set<String> requiredModIds, Set<BodyPart> hiddenBodyParts) {
        this(id, type, layerLocation, layerDefinition, texture, requiredModIds, hiddenBodyParts, false);
    }

    protected BaseAddon(ResourceLocation id, AddonType type, ModelLayerLocation layerLocation,
            Supplier<LayerDefinition> layerDefinition, ResourceLocation texture,
            Set<String> requiredModIds, Set<BodyPart> hiddenBodyParts, boolean usePlayerSkin) {
        this.id = id;
        this.type = type;
