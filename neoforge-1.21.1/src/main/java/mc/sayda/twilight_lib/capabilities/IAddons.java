 ...
 * Addons are 3D model attachments that render on top of the player (e.g., tails, wings).
 *
 * <p>Addons have two states:
 * <ul>
 *   <li><b>Owned</b>: Addons the player has unlocked (via supporter tier or admin grant)</li>
 *   <li><b>Active</b>: Addons currently equipped and visible (multiple can be active simultaneously)</li>
 * </ul>
 *
 * <p>Players manage addons via /cosmetics addons commands.
...
public interface IAddons extends ISerializableData {
    ...
    // Active addons (what's currently visible) - plural because multiple can be active
    /**
