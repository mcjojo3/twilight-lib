...
public class DryadVinesModel<T extends Entity> extends BaseAddonModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(TwilightLib.MODID, "dryad_vines"), "main");

    public DryadVinesModel(ModelPart root) {
